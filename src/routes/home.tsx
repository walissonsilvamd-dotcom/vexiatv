...
import { removeWatch } from "../lib/history-store";
import { useProgressList } from "../lib/progress-store";
    ...
    <main ref={pageRef} className="relative h-screen w-full overflow-hidden bg-vexia-bg text-vexia-text">
      ...
      <div className="relative flex h-full w-full">
        ...
        <aside className="relative z-30 flex w-[22vw] max-w-[280px] flex-col bg-black/30 backdrop-blur-2xl border-r border-white/10">
          <div className="absolute -top-12 left-0 right-0 flex justify-center py-0">
            <VexiaLogo
