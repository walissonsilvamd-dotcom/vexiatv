  ...
  return (
    <div className="grid place-items-center rounded-2xl border border-vexia-purple/30 bg-vexia-card/60 px-6 py-14 text-center">
      ...
      <div className="mt-5 flex flex-wrap items-center justify-center gap-3">
        <Link
          to="/filtros"
          className="vexia-focus rounded-full bg-vexia-purple px-6 py-2.5 text-xs font-bold tracking-wide text-white shadow-[0_0_18px_rgb(var(--vexia-primary-rgb)/0.45)]"
        >
          AJUSTAR FILTROS
        </Link>
        {onClear ? (
